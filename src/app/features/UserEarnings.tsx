...
export default function UserEarnings() {
  ...
  return <UserEarningsWrapper>
    <ValueDescriptor color="primary" description="Ganhos no mês" value={560_322.32} isCurrency />
    ...
    <ValueDescriptor color="primary" description="Total de palavras" value={2_345_347} />
  </UserEarningsWrapper>
